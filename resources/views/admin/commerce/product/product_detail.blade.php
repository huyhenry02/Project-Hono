                       ...
                       "selector": "#fancyboxGallery .js-fancybox-item"
                                ...
                                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    ...
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="/manage/assets\img\400x400\img7.jpg" alt="Image Description">
                                ...
                                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    <!-- Card -->
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="/manage/assets\img\400x400\img8.jpg" alt="Image Description">
                                ...
                                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    <!-- Card -->
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="/manage/assets\img\400x400\img9.jpg" alt="Image Description">
                                ...
                                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    <!-- Card -->
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="/manage/assets\img\400x400\img10.jpg" alt="Image Description">
                            ...
                            <div id="attachFilesNewProjectLabel" class="js-dropzone dropzone-custom custom-file-boxed">
                                <div class="dz-message custom-file-boxed-label">
                                    <img class="avatar avatar-xl avatar-4by3 mb-3" src="/manage/assets\svg\illustrations\browse.svg" alt="Image Description">
                  ...
                  "limit": 100
                        ...
                        <div class="table-responsive datatable-custom">
                         ...
                         "isShowPaging": false
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <img class="avatar" src="/manage/assets\img\400x400\img7.jpg" alt="Image Description">
                                    </th>
                        ...
                        <table style="display: none;">
                            <tr id="addVariantsTemplate">
                                ...
                                <th>
                                    <img class="avatar" src="/manage/assets\img\400x400\img2.jpg" alt="Image Description">
                                </th>
                                <th class="table-column-pl-0">
